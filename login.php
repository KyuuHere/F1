...
<body>
  ...
  <main class="login-container">
    <div class="login-card">
      ...
      <p class="subtitle">Zadej přihlašovací údaje</p>
      ...
      <p class="footer-note">Návrat na <a href="./index.php" class="footer-link">hlavní stránku</a></p>
    </div>
  </main>
</body>
</html>
